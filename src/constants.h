...
namespace regnault
{
	namespace consts
	{
		...
		namespace chemical
		{
			...
			const double REGNAULT_CONST = regnault::consts::si_base::BOLTZMANN_CONST * regnault::consts::si_base::AVOGADRO_CONST; /*J/molK*/
		}
		namespace mechanical
		{
			...
			const double SGRAVACCEL_EARTH = 9.80665;
		}
